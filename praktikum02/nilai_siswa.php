    ...
    <div class="container" style="margin-bottom: 300px;">
        <?php if (isset($_POST['simpan'])): ?>
            <ul class="list-group list-group-flush" style="width: 500px;">
                ...
                <li class="list-group-item">Hasil : <?= $nilai_total > 55 ? '<span class="badge bg-success">Lulus</span>' : '<span class="badge bg-danger">Tidak Lulus</span>' ?></li>
                <?php $grade = '';
                ...
                ?>
                <li class="list-group-item">Grade : <?= $nilai_total > 69 ? "<span class='text-success fw-bold'>$grade</span>" : "<span class='text-danger fw-bold'>$grade</span>" ?></li>
                <?php $predikat = '';
                    switch ($grade) {
                        case 'A':
                ...
                ?>
                <li class="list-group-item">Predikat : <?= $nilai_total > 69 ? "<span class='text-success fw-bold'>$predikat</span>" : "<span class='text-danger fw-bold'>$predikat</span>" ?></li>
            </ul>
